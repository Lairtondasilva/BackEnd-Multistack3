...
@RestControllerAdvice//essa classe será aplicada para todos os controllers
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    HttpHeaders headers,
      ...
      WebRequest request
          ...
          .errors(converteFieldError(exception.getBindingResult().getFieldErrors()))
          .build();
    return new ResponseEntity<>(body, status);
  }

  private Map<String, List<String>> converteFieldError(List<FieldError> fieldErrors){
